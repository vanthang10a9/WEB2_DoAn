    ...
    if ($result != null) {
        $id_div_product = -1; //đánh số id cho từng ô sản phẩm ( thằng ajax phân trang cần ) (mặc định 0 -> 7)
        while ($row = mysqli_fetch_array($result)) { 
            $id_div_product ++ ;
            ?>
            <div id="id-div-product-<?php echo $id_div_product; ?>" class="col-md-6 col-lg-3 ">
                <div class="product">
        ...
        <div class="block-27">
            <ul id="pagination">
                ...
                for ($i = 1; $i <= $total_page; $i++) {
                    ...
                    <?php } else { ?>
                        <li><a id="<?= $i ?>" data-index="<?= $i ?>"><?php echo $i; ?></a></li>
                    <?php }
                }
